...
CREATE TABLE IF NOT EXISTS agent_steps (
  ...
  phase_title       TEXT    NOT NULL,     -- Generated by Agent
  message           TEXT    NOT NULL,     -- short human-readable message, generated by Agent
  phase             TEXT    NOT NULL,     -- in_progress | complete | error
